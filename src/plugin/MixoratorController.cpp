...
const char* verdictText(Analysis::Verdict v, Localization::Language language) noexcept
{
    if (language == Localization::Language::German)
    {
        switch (v)
        {
            ...
            case Analysis::Verdict::Unusual: return "UNGEWOEHNLICH";
...
{
    editor_ = e;
    if (e) e->requestResize(uiDetailsVisible_ ? kDetailsSize : kCompactSize);
